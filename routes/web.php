...
Route::middleware(['auth', '2fa.enrolled', '2fa.verified'])->group(function () {
    ...
    Route::get('/business-entities/{businessEntity}/assets/{asset}/move-to-trust/form', [AssetShowWorkspaceController::class, 'moveToTrustForm'])->name('business-entities.assets.move-to-trust.form');
    ...
    Route::get('/business-entities/{businessEntity}/bank-account-links/{bankAccountLink}/form/edit', [BankAccountsWorkspaceController::class, 'editLinkForm'])->name('entities.bank-account-links.form.edit');
    ...
    Route::put('/business-entities/{businessEntity}/bank-account-links/{bankAccountLink}', [BusinessEntityController::class, 'updateBankAccountLink'])->name('business-entities.bank-account-links.update');
    ...
    Route::get('business-entities/{businessEntity}/invoices/{invoice}/download', [InvoiceController::class, 'download'])->name('business-entities.invoices.download');
    ...
    Route::post('business-entities/{businessEntity}/invoices/{invoice}/unpost', [InvoiceController::class, 'unpost'])->name('business-entities.invoices.unpost');
