...
- Loan-purpose import UI uses `Transaction::loanActivityTypeSelectGroups()` (loan activity + director loan in/out) and “Update loan activity”. Do not mix loan pending lines into operating cash unmatched totals.
