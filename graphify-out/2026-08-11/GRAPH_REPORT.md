...
## Corpus Check
- 708 files · ~288,220 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3958 nodes · 8664 edges · 547 communities (437 shown, 110 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 487 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29947515`
...
## Communities (547 total, 110 thin omitted)
...
### Community 40 - "Illuminate\Http\UploadedFile"
Cohesion: 0.18
...
Cohesion: 0.05
Nodes (14): DepreciationSchedule, Email, EmailDraft, MailAttachment, MailLabel, MailMessage, TransactionLine, AuthServiceProvider (+6 more)
...
Cohesion: 0.06
Nodes (5): ensureNotClosed(), ensureOperationalForAccounting(), InvoiceLine, up(), Illuminate\Database\Eloquent\Relations\Relation
...
Cohesion: 0.04
Nodes (5): BankAccountPanelController, BankAccountTransactionController, BankAccount, SecurityAuditLogger, BankAccountFormTest
...
### Community 99 - "DocumentCategory"
Cohesion: 0.15
Nodes (7): DocumentCategory, backfillCategoriesAndLabels(), up(), backfillNullLabels(), deduplicateLabels(), reassignOrphans(), up()
...
### Community 224 - "financial-reports-hub.js"
Cohesion: 0.43
...
### Community 506 - "balance-sheet-entries/create.blade.php"
Cohesion: 0.50
...
- **Why does `BusinessEntity` connect `BusinessEntity` to `Attribute Encryption Trait`, `Reminder`, `Illuminate\Http\Resources\Json\JsonResource`, `AppServiceProvider.php`, `BankStatementEntry`, `Commitment`, `Illuminate\Http\RedirectResponse`, `Invoice`, `TrackingCategory`, `ContactList`, `EntityPerson`, `ComplianceYearRecord`, `Carbon\Carbon`, `User`, `FinancialReportService`, `Document`, `Lease`, `ComplianceCategory`, `MailMessageController`, `.storeBankAccount`, `ComplianceDocumentFile`, `ComplianceReportController`, `BusinessEntityController`, `Illuminate\Http\UploadedFile`, `Illuminate\Database\Eloquent\Relations\HasMany`, `ASIC Renewal Testing`, `Tenant`, `Illuminate\Database\Eloquent\Model`, `LoanOffsetTransactionGuard`, `ComplianceWorkspaceController.php`, `web.php`, `PHPUnit\Framework\TestCase`, `PersonsWorkspaceController`, `Illuminate\Support\Collection`, `BankAccountAssetLinkService`, `Illuminate\Console\Command`, `BankAccount`, `.asicAnniversaryInYear`, `TransactionPayerResolver`, `Entity Registration Testing`, `Illuminate\Http\Request`, `Australian Address Formatting`, `ChartOfAccount`, `JournalEntry`, `DocumentUploadService`, `BusinessEntityBankAccount`, `AssetsWorkspaceController`, `FinancialYear`, `DocumentWorkspaceController`, `Illuminate\Http\JsonResponse`, `TableSort`, `DocumentCategory`, `AssetController`, `Note`, `BusinessEntity.php`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `BankAccount` connect `BankAccount` to `BusinessEntity`, `Attribute Encryption Trait`, `Reminder`, `BankStatementEntry`, `AssetSummaryReportService`, `DocumentStorage`, `Invoice`, `.groupedByHolder`, `Asset`, `EntityPerson`, `.storeBankAccount`, `BankAccountStatement`, `BusinessEntityController`, `Illuminate\Http\UploadedFile`, `Illuminate\Database\Eloquent\Relations\HasMany`, `Illuminate\Database\Eloquent\Model`, `LoanOffsetTransactionGuard`, `web.php`, `PHPUnit\Framework\TestCase`, `PersonsWorkspaceController`, `BankAccountAssetLinkService`, `DocumentUploadValidation`, `BankAccountMaskingTest`, `TransactionPayerResolver`, `Illuminate\Http\Request`, `BusinessEntityBankAccount`, `FinancialYear`, `AssetController`, `BusinessEntity.php`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Asset` connect `Asset` to `BusinessEntity`, `Reminder`, `Illuminate\Http\Resources\Json\JsonResource`, `AppServiceProvider.php`, `Commitment`, `Illuminate\Http\RedirectResponse`, `AssetSummaryReportService`, `ComplianceYearRecord`, `User`, `Document`, `Lease`, `MailMessageController`, `ComplianceDocumentFile`, `BusinessEntityController`, `Illuminate\Http\UploadedFile`, `Tenant`, `Illuminate\Database\Eloquent\Model`, `LoanOffsetTransactionGuard`, `ComplianceWorkspaceController.php`, `web.php`, `PHPUnit\Framework\TestCase`, `Illuminate\Support\Collection`, `BankAccountAssetLinkService`, `PropertyReportService`, `Illuminate\Http\Request`, `JournalEntry`, `DocumentUploadService`, `AssetsWorkspaceController`, `CarReportService`, `DocumentWorkspaceController`, `DocumentCategory`, `AssetController`, `Note`, `BusinessEntity.php`?**
