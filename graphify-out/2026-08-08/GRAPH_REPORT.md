...
## Corpus Check
- 631 files · ~245,568 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3413 nodes · 7624 edges · 510 communities (389 shown, 121 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 480 edges (avg confidence: 0.79)
...
## Communities (510 total, 121 thin omitted)

### Community 0 - "BusinessEntity"
Cohesion: 0.04
Nodes (6): ensureNotClosed(), ensureOperationalForAccounting(), BusinessEntity, Carbon, HeaderSearchIndex, Carbon\CarbonInterface

### Community 1 - "Illuminate\Http\JsonResponse"
Cohesion: 0.09
Nodes (5): AdminUsersWorkspaceController, UserManagementController, BankAccountsWorkspaceController, EmailTemplateController, Illuminate\Http\JsonResponse

### Community 2 - "BankAccount"
Cohesion: 0.07
Nodes (3): BankAccountTransactionController, BankAccount, BusinessEntityBankAccount
...
Cohesion: 0.05
Nodes (12): DepreciationSchedule, Email, EmailDraft, InvoiceLine, MailAttachment, TransactionLine, AuthServiceProvider, Illuminate\Database\Eloquent\Factories\HasFactory (+4 more)
...
Cohesion: 0.06
Nodes (21): AuthenticatedSessionController, ConfirmablePasswordController, EmailVerificationNotificationController, EmailVerificationPromptController, NewPasswordController, PasswordController, PasswordResetLinkController, TwoFactorController (+13 more)
...
### Community 31 - "MailMessageController"
Cohesion: 0.06
...
### Community 46 - "Person"
Cohesion: 0.14
Nodes (3): EntityShowWorkspaceController, PersonShowWorkspaceController, Person
...
### Community 59 - "Illuminate\Contracts\Validation\ValidationRule"
Cohesion: 0.19
...
### Community 78 - "entity-create-form.js"
Cohesion: 0.44
...
Cohesion: 0.08
Nodes (3): EmailTemplatesWorkspaceController, PersonsIndexWorkspaceController, TableSort
...
### Community 94 - "AppServiceProvider.php"
Cohesion: 0.38
Nodes (3): AppServiceProvider, PasswordPolicy, Illuminate\Validation\Rules\Password
...
### Community 104 - "Note"
Cohesion: 0.12
Nodes (4): Note, RealEstateCompany, RealEstateCompanyContact, up()
...
- **Why does `BusinessEntity` connect `BusinessEntity` to `Illuminate\Http\JsonResponse`, `BankAccount`, `ComplianceCategory`, `.rule`, `Reminder`, `Illuminate\Http\RedirectResponse`, `Illuminate\Database\Eloquent\Model`, `FinancialYear`, `PersonsWorkspaceController`, `TrackingCategory`, `AssetShowWorkspaceController`, `Asset`, `DocumentWorkspaceController.php`, `EntityPerson`, `ComplianceYearRecord`, `Carbon\Carbon`, `FinancialReportService`, `MailMessageController`, `Lease`, `Commitment`, `BusinessEntityPolicy`, `Illuminate\Http\Request`, `BankAccountPanelController`, `ComplianceReportController`, `TransactionPayerResolver`, `BusinessEntityAsicRenewalDueDateTest`, `Person`, `Invoice`, `ChartOfAccount`, `BankAccountAssetLinkService`, `DocumentCategory`, `Illuminate\Http\Resources\Json\JsonResource`, `FinancialReportController`, `Illuminate\Support\Collection`, `Illuminate\Console\Command`, `BankStatementEntry`, `web.php`, `Illuminate\Database\Eloquent\Relations\HasMany`, `.buildDirectorEntityLoanAccountBlock`, `BusinessEntityRegistrationDateTest`, `.storeTransaction`, `AustralianAddress`, `AssetsWorkspaceController`, `EncryptsAttributes.php`, `DocumentUploadService`, `JournalEntry`, `DocumentController`, `ComplianceDocumentFile`, `TableSort`, `ComplianceController`, `AppServiceProvider.php`, `ContactList`, `ReportEntityScopeResolver`, `Note`, `BusinessEntityController.php`, `BankAccountAssetLinkService.php`, `.canAccessEntity`?**
  _High betweenness centrality (0.163) - this node is a cross-community bridge._
- **Why does `BankAccount` connect `BankAccount` to `Illuminate\Http\JsonResponse`, `BankAccountFormTest`, `.rule`, `Illuminate\Database\Eloquent\Model`, `Reminder`, `FinancialYear`, `PersonsWorkspaceController`, `Asset`, `EntityPerson`, `AssetSummaryReportService`, `DocumentStorage`, `BankAccountStatement`, `Illuminate\Http\Request`, `BankAccountPanelController`, `Person`, `BankAccountAssetLinkService`, `BankStatementEntry`, `web.php`, `Illuminate\Database\Eloquent\Relations\HasMany`, `.storeTransaction`, `EncryptsAttributes.php`, `DocumentUploadService`, `TableSort`, `BankAccountMaskingTest`, `BusinessEntityController.php`, `.groupedByHolder`, `BankAccountAssetLinkService.php`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `Asset` connect `Asset` to `BusinessEntity`, `.rule`, `Reminder`, `Illuminate\Database\Eloquent\Model`, `Illuminate\Http\RedirectResponse`, `CarReportService`, `AssetShowWorkspaceController`, `DocumentWorkspaceController.php`, `PHPUnit\Framework\TestCase`, `ComplianceYearRecord`, `User`, `AssetSummaryReportService`, `MailMessageController`, `Lease`, `Commitment`, `BankAccountAssetLinkService`, `DocumentCategory`, `Illuminate\Http\Resources\Json\JsonResource`, `Illuminate\Support\Collection`, `Document`, `PropertyReportService`, `web.php`, `Illuminate\Database\Eloquent\Relations\HasMany`, `.storeTransaction`, `AssetsWorkspaceController`, `DocumentUploadService`, `ComplianceDocumentFile`, `ComplianceController`, `Note`, `BusinessEntityController.php`?**
