...
## Corpus Check
- 627 files · ~243,523 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3393 nodes · 7552 edges · 507 communities (385 shown, 122 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 476 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `20d28636`
...
- SecurityAudit
- 2026_03_22_000001_create_real_estate_companies_and_migrate_tenant_links.php
- SetupSecurity
...
## Communities (507 total, 122 thin omitted)

### Community 0 - "BusinessEntity"
Cohesion: 0.04
Nodes (4): ensureNotClosed(), ensureOperationalForAccounting(), RentInvoiceController, BusinessEntity

### Community 2 - "BankAccount"
Cohesion: 0.07
Nodes (4): BankAccountTransactionController, BankAccount, down(), up()
...
Cohesion: 0.06
Nodes (7): BillsTasksController, Collection, ReminderController, Reminder, ReminderPolicy, Illuminate\Auth\Access\HandlesAuthorization, Illuminate\Database\Eloquent\Builder
...
Cohesion: 0.14
Nodes (27): alertHttpError(), alertValidationErrors(), api(), boot(), buildRowActionsHtml(), buildSlotRow(), capitalize(), escAttr() (+19 more)

### Community 14 - "app.js"
Cohesion: 0.13
Nodes (32): initAddressFieldSync(), syncAddressFieldsInForm(), bootApp(), exposeRichTextHelpers(), initEntityCreateForm(), initEntityFormFields(), setCompanyFieldsState(), setInputDisabled() (+24 more)
...
### Community 21 - "Illuminate\View\View"
Cohesion: 0.11
Nodes (9): CarReportController, mergeReportFormScope(), resolveReportEntityIds(), ProfileController, PropertyReportController, AppLayout, GuestLayout, Illuminate\View\Component (+1 more)
...
Cohesion: 0.07
Nodes (5): EntityPersonController, EntityShowWorkspaceController, PersonShowWorkspaceController, EntityPerson, Person
...
Cohesion: 0.19
Nodes (5): AddXeroChartOfAccounts, BackfillComplianceDueDates, ScheduleBackup, Illuminate\Console\Command, Illuminate\Support\Facades\Schedule
...
Cohesion: 0.06
Nodes (8): AdminUsersWorkspaceController, UserManagementController, EmailTemplateController, EmailTemplatesWorkspaceController, PersonsIndexWorkspaceController, TableSort, Illuminate\Http\JsonResponse, Illuminate\Http\Request
...
Cohesion: 0.12
Nodes (8): EncryptedFilesystemAdapter, AppServiceProvider, EncryptedFilesystemServiceProvider, PasswordPolicy, Illuminate\Filesystem\FilesystemAdapter, Illuminate\Support\ServiceProvider, Illuminate\Validation\Rules\Password, League\Flysystem\Filesystem

### Community 95 - "ContactList"
Cohesion: 0.14
Nodes (4): ContactListController, ContactListsWorkspaceController, ContactList, ContactListPolicy

### Community 96 - "compliance-workspace.js"
Cohesion: 0.20
...
### Community 496 - "DocumentStorage.php"
Cohesion: 0.22
Nodes (3): up(), up(), Illuminate\Http\UploadedFile

### Community 497 - "financial-reports-hub.js"
Cohesion: 0.43
...
### Community 502 - "autoload-dev"
Cohesion: 0.67
Nodes (3): autoload-dev, psr-4, Tests\\

## Knowledge Gaps
- **334 isolated node(s):** `py`, `context7`, `$schema`, `name`, `type` (+329 more)
...
- **Why does `BusinessEntity` connect `BusinessEntity` to `BankAccount`, `MailMessageController`, `ComplianceCategory`, `DocumentController`, `Reminder`, `Illuminate\Http\RedirectResponse`, `FinancialYear`, `PersonsWorkspaceController`, `TrackingCategory`, `Tenant`, `Asset`, `Illuminate\View\View`, `BusinessEntityBankAccount`, `EntityPerson`, `ComplianceYearRecord`, `Carbon\Carbon`, `Transaction`, `Illuminate\Support\Collection`, `FinancialReportService`, `Invoice`, `Lease`, `Commitment`, `.asicAnniversaryInYear`, `.rule`, `BankAccountPanelController`, `ComplianceReportController`, `TransactionPayerResolver`, `BusinessEntityAsicRenewalDueDateTest`, `.update`, `ChartOfAccount`, `BankAccountAssetLinkService`, `DocumentCategory`, `FinancialYear.php`, `MailMessage`, `FinancialReportController`, `ComplianceReportService`, `BankStatementEntry`, `web.php`, `BusinessEntityRegistrationDateTest`, `BusinessEntityController`, `AustralianAddress`, `AssetsWorkspaceController`, `EncryptsAttributes.php`, `BusinessEntityPolicy`, `DocumentUploadService`, `ComplianceDocumentFile`, `Illuminate\Http\Request`, `ComplianceController`, `EncryptedFilesystemAdapter`, `ContactList`, `2026_03_22_000001_create_real_estate_companies_and_migrate_tenant_links.php`, `Illuminate\Database\Eloquent\Model`, `DocumentStorage.php`, `.canAccessEntity`, `.build`?**
  _High betweenness centrality (0.158) - this node is a cross-community bridge._
- **Why does `BankAccount` connect `BankAccount` to `BankAccountFormTest`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Reminder`, `FinancialYear`, `PersonsWorkspaceController`, `Asset`, `BusinessEntityBankAccount`, `EntityPerson`, `Transaction`, `Illuminate\Support\Collection`, `DocumentStorage`, `BankAccountStatement`, `.rule`, `BankAccountPanelController`, `TransactionPayerResolver`, `.update`, `BankAccountAssetLinkService`, `.businessEntity`, `BankStatementEntry`, `web.php`, `Illuminate\Database\Eloquent\Relations\HasMany`, `BusinessEntityController`, `EncryptsAttributes.php`, `Illuminate\Http\Request`, `BankAccountMaskingTest`, `Illuminate\Database\Eloquent\Model`, `DocumentStorage.php`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `Transaction` connect `Transaction` to `Illuminate\Database\Eloquent\Relations\BelongsTo`, `Reminder`, `Illuminate\Http\RedirectResponse`, `Vendor`, `Illuminate\Support\Collection`, `FinancialReportService`, `DocumentStorage`, `TransactionPayerResolver`, `.update`, `Document`, `PropertyReportService`, `BankStatementEntry`, `Illuminate\Database\Eloquent\Relations\HasMany`, `TransactionPostingService`, `BusinessEntityController`, `DocumentUploadService`, `JournalEntry`, `Illuminate\Http\Request`, `EncryptedFilesystemAdapter`, `Illuminate\Database\Eloquent\Model`, `DocumentStorage.php`?**
