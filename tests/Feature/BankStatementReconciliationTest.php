...
it('includes shared reconciliation panel markup and JS module', function () {
    ...
    expect($panel)->toContain('data-reconciliation-panel')
        ...
        ->and($panel)->toContain('data-bank-import-candidates')
        ->and($panel)->toContain('data-bank-import-candidate-count')
        ->and($panel)->toContain('data-bank-import-transaction')
        ->and($panel)->toContain('No unmatched booked transactions for this entity yet')
        ...
        ->and($js)->toContain('fillMatchSelect')
        ->and($js)->toContain('readCandidatesFromPanel')
        ...
        ->and($js)->toContain('getSelectValue')
