...
it('includes download actions on the invoice index and show views', function () {
    ...
    expect($index)->toContain('business-entities.invoices.download')
        ...
        ->and($index)->toContain('invoice-filters-panel')
        ->and($index)->toContain('Invoice list')
        ...
        ->and($print)->not->toContain('${{ number_format')
        ->and($print)->not->toContain('Amounts in')
        ->and($print)->toContain('class="card"')
        ->and($print)->toContain('Tax invoice')
        ->and($print)->toContain('class="page"')
        ->and($edit)->toContain('Edit Invoice')
        ->and($form)->toContain('Invoice details')
        ->and($form)->toContain('Customer &amp; lease')
        ->and($form)->toContain('Yes — GST applies')
