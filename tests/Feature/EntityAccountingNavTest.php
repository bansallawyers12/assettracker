...
it('explains missing accounting tabs for tenancy property-manager contacts', function () {
    ...
    expect($show)->toContain('data-tenancy-contact-banner')
        ...
        ->and($show)->toContain('Creating invoices and linking bank accounts')
        ...
        ->and($show)->toContain('data-tenancy-invoices-notice')
        ->and($show)->toContain('data-tenancy-bank-accounts-notice')
