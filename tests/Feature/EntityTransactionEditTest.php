...
it('uses the statement classify view when a transaction is linked to a bank statement line', function () {
    ...
    expect($controller)->toContain('isLinkedToBankStatement()')
        ...
        ->and($statementEdit)->toContain('data-statement-edit-locked-notice')
        ->and($statementEdit)->toContain('data-statement-edit-full-form-path')
        ->and($statementEdit)->toContain('Locked')
        ->and($statementEdit)->toContain('full edit form')
