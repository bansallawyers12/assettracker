...
return [
    ...
    */
    ...
    'headers' => [
        ...
        //
        // Also allow: Office Online embed (resources/js/documents.js), and https: on connect-src /
        // frame-src so presigned S3 URLs work across regions (standard host wildcards do not match
        // bucket.s3.region.amazonaws.com).
        'content_security_policy' => env(
            'CONTENT_SECURITY_POLICY',
            "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'{$viteDevHttp} https://*.googleapis.com https://*.gstatic.com *.google.com https://*.ggpht.com *.googleusercontent.com blob:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://fonts.bunny.net{$viteDevHttp}; img-src 'self' data: https: blob:; font-src 'self' data: https://fonts.gstatic.com https://fonts.bunny.net; connect-src 'self'{$viteDevHttp}{$viteDevWs} https://*.googleapis.com *.google.com https://*.gstatic.com https: data: blob:; object-src 'self' https: blob:; frame-src 'self' https://view.officeapps.live.com *.google.com https: blob:; worker-src blob:; frame-ancestors 'none';"
        ),
