...
<x-app-layout>
    <x-slot name="header">
        <div class="min-w-0">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ $asset->asset_type }}</p>
        </div>
    </x-slot>
    ...
    <div
        ...
        x-data="assetShowPage(@js($assetShowConfig))"
        x-init="init()"
    >
                ...
                <div class="flex-1 min-w-0">
                    <div class="asset-main-card bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200/80 dark:border-gray-700 overflow-hidden">
                        ...
                        <div class="border-b border-gray-100 dark:border-gray-800 px-5 py-4">
                            ...
                            @elseif ($isLeasable)
                                <button type="button" @click="setTab('tab_financials')" class="asset-quick-action bg-teal-600 hover:bg-teal-700 text-white">
                        ...
                        <div class="px-5 pt-4 pb-2">
                            <nav class="asset-tab-nav flex flex-wrap" aria-label="Asset sections" id="asset-tabs">
                                <a href="#tab_details" class="tab-link" :class="{ 'active': activeTab === 'tab_details' }" @click.prevent="setTab('tab_details')">Details</a>
                                @if ($asset->asset_type === 'Car')
                                    <a href="#tab_registration" class="tab-link" :class="{ 'active': activeTab === 'tab_registration' }" @click.prevent="setTab('tab_registration')">Registration</a>
                                    <a href="#tab_insurance" class="tab-link" :class="{ 'active': activeTab === 'tab_insurance' }" @click.prevent="setTab('tab_insurance')">Insurance</a>
                                    <a href="#tab_service" class="tab-link" :class="{ 'active': activeTab === 'tab_service' }" @click.prevent="setTab('tab_service')">Service History</a>
                                @elseif ($isLeasable)
                                    <a href="#tab_tenants" class="tab-link" :class="{ 'active': activeTab === 'tab_tenants' }" @click.prevent="setTab('tab_tenants')">Tenants</a>
                                    <a href="#tab_leases" class="tab-link" :class="{ 'active': activeTab === 'tab_leases' }" @click.prevent="setTab('tab_leases')">Leases</a>
                                    <a href="#tab_financials" class="tab-link" :class="{ 'active': activeTab === 'tab_financials' }" @click.prevent="setTab('tab_financials')">Financials</a>
                                    <a href="#tab_invoices" class="tab-link" :class="{ 'active': activeTab === 'tab_invoices' }" @click.prevent="setTab('tab_invoices')">Invoices</a>
                                @else
                                    <a href="#tab_financials" class="tab-link" :class="{ 'active': activeTab === 'tab_financials' }" @click.prevent="setTab('tab_financials')">Financials</a>
                                @endif
                                <a href="#tab_transactions" class="tab-link" :class="{ 'active': activeTab === 'tab_transactions' }" @click.prevent="setTab('tab_transactions')">Transactions</a>
                                <a href="#tab_documents" class="tab-link" :class="{ 'active': activeTab === 'tab_documents' }" @click.prevent="setTab('tab_documents')">Documents</a>
                                <a href="#tab_compliance" class="tab-link" :class="{ 'active': activeTab === 'tab_compliance' }" @click.prevent="setTab('tab_compliance')">Compliance</a>
                                <a href="#tab_notes" class="tab-link" :class="{ 'active': activeTab === 'tab_notes' }" @click.prevent="setTab('tab_notes')">Notes</a>
                                <a href="#tab_reminders" class="tab-link" :class="{ 'active': activeTab === 'tab_reminders' }" @click.prevent="setTab('tab_reminders')">Reminders</a>
                                <a href="#tab_emails" class="tab-link" :class="{ 'active': activeTab === 'tab_emails' }" @click.prevent="setTab('tab_emails')">Emails</a>
                            </nav>
                        </div>
                        ...
                        <div class="tab-content-container px-5 pb-6">
                            <!-- Details Tab -->
                            <div id="tab_details" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                            ...
                            @if ($asset->asset_type === 'Car')
                                <div id="tab_registration" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                                    <div class="asset-panel">
                                ...
                                <!-- Car: Insurance Tab -->
                                <div id="tab_insurance" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                                    <div class="asset-panel">
                                ...
                                <div id="tab_service" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                                    <div class="asset-panel">
                            ...
                            @elseif ($isLeasable)
                                ...
                                <div id="tab_tenants" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                                    <div class="asset-panel">
                                ...
                                <div id="tab_leases" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                                    <div class="asset-panel">
                            ...
                            <div id="tab_transactions" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                            ...
                            <!-- Documents Tab -->
                            <div id="tab_documents" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                                <div class="asset-panel">
                            ...
                            <!-- Compliance Tab -->
                            <div id="tab_compliance" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                                <div class="asset-panel">
                            ...
                            <!-- Notes Tab -->
                            <div id="tab_notes" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                                <div class="asset-panel">
                                    <div class="flex justify-between items-center mb-4">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Notes</h3>
                                        <button type="button" class="inline-flex items-center px-3 py-1 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg text-sm shadow-md transition-all duration-200" @click="showNoteForm = !showNoteForm">
                                    ...
                                    <!-- Add Note Form -->
                                    <form id="note-form" x-show="showNoteForm" x-cloak class="mb-4 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xs" method="POST" action="{{ route('business-entities.assets.notes.store', [$businessEntity->id, $asset->id]) }}#tab_notes">
                                        @csrf
                                        <div class="mb-4">
                            ...
                            <!-- Reminders Tab -->
                            <div id="tab_reminders" class="tab-content" x-show="activeTab === $el.id" style="display: none;">
                                <div class="asset-panel border-amber-200/60 dark:border-amber-900/40 bg-amber-50/50 dark:bg-amber-950/20">
                                    <div class="flex justify-between items-center mb-4">
                                        ...
                                        <button type="button" class="inline-flex items-center bg-yellow-100 hover:bg-yellow-200 text-yellow-700 dark:bg-yellow-900 dark:hover:bg-yellow-800 dark:text-yellow-200 px-3 py-1 rounded-md text-sm" @click="showReminderForm = !showReminderForm">
                                            <x-lucide-plus class="h-4 w-4 mr-1" />
                                            Add Reminder
                                        </button>
                                    </div>
                                    <form id="reminder-form" x-show="showReminderForm" x-cloak class="mb-4 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xs" method="POST" action="{{ route('business-entities.assets.notes.store', [$businessEntity->id, $asset->id]) }}#tab_reminders">
                                        @csrf
                                        <div class="mb-4">
                                    ...
                                    @if ($allocatedEmails->isEmpty())
                                        <div class="rounded-xl border border-dashed border-gray-200 bg-gray-50/80 px-6 py-12 text-center dark:border-gray-700 dark:bg-gray-800/40">
                                            <div class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-xs dark:bg-gray-900">
                                                <x-lucide-mail class="h-6 w-6 text-gray-400" aria-hidden="true" />
                                            </div>
                                            <p class="text-sm font-semibold text-gray-900 dark:text-white">No emails allocated yet</p>
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Emails linked to this asset will appear here.</p>
                                        </div>
                                    @else
