                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('business-entities.assets.update', [$asset->business_entity_id, $asset->id]) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="asset_type" id="asset_type" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $asset->name) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="current_value" id="current_value" value="{{ old('current_value', $asset->current_value) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500" required>
                            @error('current_value') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-4">
                            <label for="status" class="block text-sm font-medium text-gray-700">Status</label>
                            <select name="status" id="status" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500" required>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500">{{ old('description', $asset->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="insurance_company" id="insurance_company" value="{{ old('insurance_company', $asset->insurance_company) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="0.01" name="insurance_amount" id="insurance_amount" value="{{ old('insurance_amount', $asset->insurance_amount) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div id="car-fields" class="hidden mb-4">
                            ...
                            <input type="number" name="mileage" id="mileage" value="{{ old('mileage', $asset->mileage) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div id="property-fields" class="hidden mb-4">
                            ...
                            <x-google-address-input name="address" id="address" :value="old('address', $asset->address)" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500" />
                            @error('address') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            <label for="square_footage" class="block text-sm font-medium text-gray-700">Square Footage</label>
                            <input type="number" name="square_footage" id="square_footage" value="{{ old('square_footage', $asset->square_footage) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500">
                            ...
                            <input type="number" step="0.01" name="real_estate_percentage" id="real_estate_percentage" value="{{ old('real_estate_percentage', $asset->real_estate_percentage) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-xs focus:ring-indigo-500 focus:border-indigo-500" placeholder="e.g., 2.5">
