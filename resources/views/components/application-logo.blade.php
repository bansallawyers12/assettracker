<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width="48" height="48" {{ $attributes }}>
    <rect x="2" y="6" width="44" height="36" rx="4" ry="4" fill="none" stroke="currentColor" stroke-width="2.5"/>
