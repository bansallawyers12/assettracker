...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white shadow sm:rounded-lg">
            <form action="{{ route('business-entities.tracking-categories.tracking-sub-categories.store', [$businessEntity, $trackingCategory]) }}" method="POST" class="px-4 py-5 sm:p-6">
                @csrf
