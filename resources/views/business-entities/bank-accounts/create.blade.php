            ...
            <div class="bg-white shadow-xs rounded-lg p-6">
                <form method="POST" action="{{ route('business-entities.bank-accounts.store', $businessEntity->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="bank_name" value="{{ old('bank_name') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="bsb" value="{{ old('bsb') }}" class="mt-1 block w-full border-gray-300 rounded-md" required maxlength="6" minlength="6">
                        @error('bsb') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Account Number</label>
                        <input type="text" name="account_number" value="{{ old('account_number') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
